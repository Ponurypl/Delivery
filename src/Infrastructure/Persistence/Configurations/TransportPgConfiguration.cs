...
internal sealed class TransportPgConfiguration : IEntityTypeConfiguration<Transport>
{
    public void Configure(EntityTypeBuilder<Transport> builder)
    {
        ...
        builder.Property(x => x.DelivererId).IsRequired().HasColumnName("deliverer_id").HasConversion<UserId.EfCoreValueConverter>();
        builder.Property(x => x.ManagerId).IsRequired().HasColumnName("manager_id").HasConversion<UserId.EfCoreValueConverter>();
